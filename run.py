...
navbar = dbc.NavbarSimple(
    ...
    children=[
        ...
        dbc.NavItem(html.A('Notebook', href='https://netflix-movies-recommender.herokuapp.com/notebooks/netflix-recommender-notebook.html', className='nav-link', target="_blank")), 
    ],
    sticky='top',
    color='danger', 
    light=False, 
