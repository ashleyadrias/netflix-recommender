...
navbar = dbc.NavbarSimple(
    ...
    children=[
        ...
        dbc.NavItem(dcc.Link('Notebook', href="https://github.com/ashleyadrias/netflix-recommender/blob/master/notebooks/netflix-recommender.ipynb", className='nav-link', target="_blank")),
